...
public class UserOrderDetailsPageUI {
	...
	public static final String WEB_SUB_MENU_BY_JS = "xpath=//ul[@class='top-menu notmobile']//a[contains(text(),'Computers')]/following-sibling::ul[@class='sublist first-level']//a[contains(text(),'Notebooks')]";
}
