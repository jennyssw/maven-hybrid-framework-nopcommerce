...
public class BasePageUI {
	...
	public static final String DYNAMIC_WEB_MENU_BY_TITLE = "xpath=//ul[@class='top-menu notmobile']//a[contains(string(),'%s')]";
	public static final String DYNAMIC_WEB_SUBMENU_BY_TITLE = "xpath=//ul[@class='top-menu notmobile']//a[contains(string(),'%s')]/following-sibling::ul[@class='sublist first-level']//a[contains(string(),'%s')]";
	public static final String DYNAMIC_FIELD_ERROR_MESSAGE_BY_ID = "id=%s";
	public static final String DYNAMIC_FIELD_ERROR_MESSAGE_BY_CLASS = "class=%s";
	public static final String DYNAMIC_ALERT_SUCCESS_MESSAGE_BY_TEXT = "xpath=//div[@class='content-wrapper']/div[contains(string(),'%s')]";
	public static final String PAGE_ERROR_MESSAGE = "css=div.message-error.validation-summary-errors li";
	public static final String PAGE_SUCCESS_MESSAGE = "css=div.page.registration-result-page div.result";
